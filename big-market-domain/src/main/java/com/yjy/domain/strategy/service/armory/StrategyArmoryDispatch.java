 ...
 * @create
 * 什么叫抽奖策略？每个奖品有一个概率，选概率最小的分位为1，然后计算每个奖品应该有多少个
 * 本质上就是有10各奖品，6个3等奖，3个二等，1个一等，然后建一个list，存入3333332221，然后乱序，建一个map，key是i++，val是乱序后的奖品。
 * 之后抽奖的时候就生成随机数，去map中找看是几等奖
 */
@Slf4j
@Service
public class StrategyArmoryDispatch implements IStrategyArmory,IStrategyDispatch {
    ...
    public Integer getRandomAwardId(Long strategyId) {
        ...
        //获得最大范围，再根据最大范围生成随机数，再根据随机数从map确定奖品id
